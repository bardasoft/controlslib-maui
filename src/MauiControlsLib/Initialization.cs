...
public static class Initialization
{
    ...
    /// </summary>
    /// <param name="mauiAppBuilder">The instance of the MauiAppBuilder being extended.</param>
    /// <returns>The extended MauiAppBuilder instance.</returns>
    public static MauiAppBuilder UseMauiControlsLib(this MauiAppBuilder mauiAppBuilder)
    {
